...
export default function SalariesScreen() {
    ...
    const loadSalaries = async () => {
        try {
            ...
            crossAlert('Erro', 'Não foi possível carregar os salários');
        }
    };
    ...
    const handleSave = async () => {
        ...
        if (paymentDay.trim()) {
            ...
            if (isNaN(day) || day < 1 || day > 31) {
                crossAlert('Erro', 'Dia de pagamento deve ser entre 01 e 31');
                return;
            }
        }
        ...
        try {
            ...
            loadSalaries();
            crossAlert('Sucesso', editingSalary ? 'Salário atualizado!' : 'Salário adicionado!', [
                { text: 'OK', onPress: () => setModalVisible(false) }
            ]);
        } catch (error) {
            crossAlert('Erro', 'Não foi possível salvar o salário');
        } finally {
            setIsSaving(false);
        }
    };
    ...
    const toggleActive = async (salary: Salary) => {
        try {
            ...
            crossAlert('Erro', 'Não foi possível atualizar o salário');
        }
    };
                ...
                { text: 'Cancelar', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            crossAlert('Erro', 'Não foi possível excluir o salário');
                        }
                    },
                },
            ]
